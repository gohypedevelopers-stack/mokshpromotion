            ...
            <div className="bg-white p-6 rounded-lg shadow border">
                ...
                <div className="mt-6">
                            ...
                            <tbody className="divide-y">
                                {items.map((item: any, i: number) => (
                                    <tr key={i}>
                                        ...
                                        <td className="p-2 text-right">₹{Number(item.netTotal).toLocaleString('en-IN', { maximumFractionDigits: 0 })}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
                    ...
                    <div className="flex justify-between mt-3 font-bold text-lg">
                        ...
                        <span>₹{Number(inquiry.baseTotal).toLocaleString('en-IN', { maximumFractionDigits: 0 })}</span>
                    </div>
                </div>
            </div>
                    ...
                    <div className="text-center py-8 text-gray-500">
                        ...
                        {status === "APPROVED" && (
                            <div className="mt-2 text-green-600 font-bold">
                                ...
                                <br />
                                Final Total: ₹{Number(inquiry.finalTotal).toLocaleString('en-IN', { maximumFractionDigits: 0 })}
                            </div>
                        )}
                    </div>
                )}
