...
export default async function LeadDetailPage({ params }: { params: { id: string } }) {
    ...
    // Serialize campaign items to avoid "Decimal" and "Date" warnings in Client Components
    const serializedCampaignItems = lead.campaignItems.map(item => ({
        ...item,
        // Decimals to Numbers
        ...
        bookingStartDate: item.bookingStartDate ? item.bookingStartDate.toISOString() : null,
        bookingEndDate: item.bookingEndDate ? item.bookingEndDate.toISOString() : null,
        createdAt: item.createdAt.toISOString(),
        // Relations
        inventoryHoarding: {
            ...item.inventoryHoarding,
            netTotal: Number(item.inventoryHoarding.netTotal || 0),
            widthFt: Number(item.inventoryHoarding.widthFt || 0),
            heightFt: Number(item.inventoryHoarding.heightFt || 0),
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 pt-2">
                    ...
                    */}
                    ...
                    <div className="rounded-xl border bg-white shadow-sm overflow-hidden">
                        ...
                        */}
                        <CampaignManager
                            leadId={lead.id}
                            initialItems={serializedCampaignItems}
                        />
                    </div>
                </div>
                ...
                <div className="lg:col-span-4 space-y-6">
                    <div className="lg:sticky lg:top-6 space-y-6">
                        ...
                        {/* Inventory Booking Timeline */}
                        <TimelineCard
                            leadId={lead.id}
                            inventoryItems={serializedCampaignItems}
                        />
