...
export default function Footer() {
    return (
        <footer className="bg-[#00152e] text-white pt-10 pb-6 border-t border-white/5 font-sans">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            {[
                                ...
                                <li key={item.name}>
                                    <Link href={item.path} className="text-gray-400 hover:text-white transition-colors text-sm hover:underline decoration-blue-500 decoration-2 underline-offset-4">
                                        {item.name}
                                    </Link>
                                </li>
                            ))}
